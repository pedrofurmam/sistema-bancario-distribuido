...
| `data_inicial`,`data_final`| **`String: yyyy-MM-dd'T'HH:mm:ss'Z'`** | Datas devem estar no formato ISO 8601 UTC. Exemplo: `2025-08-01T00:00:00Z`.<br>**Explicação:**<br>- `yyyy`: ano com 4 dígitos<br>- `MM`: mês com 2 dígitos<br>- `dd`: dia com 2 dígitos<br>- `'T'`: separador entre data e hora<br>- `HH`: hora (00-23)<br>- `mm`: minutos<br>- `ss`: segundos<br>- `'Z'`: indica que o horário está em UTC (tempo universal coordenado) |
