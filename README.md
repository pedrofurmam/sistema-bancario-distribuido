...
Para a correta manipulação das mensagens JSON, o projeto utiliza a biblioteca  **Jackson** . É necessário adicionar as seguintes dependências ao seu projeto Java:
